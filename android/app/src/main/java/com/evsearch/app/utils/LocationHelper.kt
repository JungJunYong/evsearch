...
object LocationHelper {
    ...
    fun getMatchingRegionCode(lat: Double, lng: Double): String {
        return when {
            ...
            lat in 37.00..38.60 && lng in 127.10..129.40 -> "51" // 강원
            lat in 37.30..37.60 && lng in 126.50..126.80 -> "28" // 인천
            lat in 36.90..38.30 && lng in 126.30..127.90 -> "41" // 경기
            lat in 36.35..36.65 && lng in 127.15..127.40 -> "36" // 세종
            lat in 36.20..36.50 && lng in 127.25..127.50 -> "30" // 대전
            lat in 36.00..37.25 && lng in 127.30..129.00 -> "43" // 충북
            lat in 35.80..37.10 && lng in 125.90..127.60 -> "44" // 충남
            ...
            lat in 35.50..37.20 && lng in 127.80..129.60 -> "47" // 경북
            lat in 34.60..35.90 && lng in 127.50..129.20 -> "48" // 경남
            lat in 35.05..35.25 && lng in 126.70..127.00 -> "29" // 광주
            lat in 35.30..36.15 && lng in 126.30..127.90 -> "45" // 전북
            lat in 34.00..35.50 && lng in 125.90..127.90 -> "46" // 전남
